...
<head>
    ...
    <title>@yield('title', 'Gam3a Admin')</title>
    <style>
...
<div class="shell">
    <aside>
        ...
        <nav>
            ...
            <a href="/admin/resources/site-content">محتوى الموقع والخدمات والأسئلة</a>
            <a href="/admin/resources/faculties">الكليات</a>
    ...
    <main>
        <div class="top">
            ...
            @auth
                <form method="post" action="/admin/logout">@csrf<button class="btn gray">خروج</button></form>
            @endauth
        </div>
